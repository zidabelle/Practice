...
bmi_formula = round(float(weight / (height * height) * 703))
bmi = int(bmi_formula)

print("Your weight is " + str(weight) + " and your height is " + str(height))  
print("Your BMI is " + str(bmi))

if bmi <= 18.5: print("You are underweight. Eat more!")
elif bmi >= 18.5 and bmi <= 24.9: print("You have a normal weight. Good job!")
elif bmi >= 25 and bmi <= 29.9: print("You are overweight. Go workout fatty!")
elif bmi >= 30: print("You are obese. Eat healthier!")